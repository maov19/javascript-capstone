  ...
  footer.innerHTML = `
        ...
        <div>
            <div class="grid grid-flow-row md:grid-flow-col gap-4">
                <span class="text-2xl">
                Shafiu:
                    <a href="https://www.linkedin.com/in/shafiu-yushawu-ibn-610883164/"><i class="fa-brands fa-linkedin-in"></i></a>
                    <a href="https://github.com/shafiuyushawu"><i class="fa-brands fa-github"></i></a>
                </span> 
                <span class="text-2xl">
                    Martin:
                    <a href="https://www.linkedin.com/in/martin-ossa/"><i class="fa-brands fa-linkedin-in"></i></a>
                    <a href="https://github.com/maov19"><i class="fa-brands fa-github"></i></a>
                </span> 
